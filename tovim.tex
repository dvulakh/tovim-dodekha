...
(\instruction{ביום שיש בו מוסף ובמלווה מלכה:} מִגְדּוֹל) \pasuk{יְשׁוּע֢וֹת
מַ֫לְכּ֥וֹ וְעֹ֤שֶׂה חֶ֨סֶד לִמְשִׁיח֗וֹ לְדָוִ֥ד וּלְזַרְע֗וֹ עַד־עוֹלָֽם׃} \pasuk[איוב כה ב]{עֹשֶׂ֥ה שָׁ֝ל֗וֹם
בִּמְרוֹמָֽיו}הוּא יַעֲשֶׂה שָלוֹם עָלֵֽינוּ וְעַל כׇּל יִשְׂרָאֵל וְאִמְרוּ: אָמֵן.
